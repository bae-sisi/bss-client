      ...
      <Modal.Body>
        <div className='space-y-6'>
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            ...
            다음과 같은 처리방침을 두고 있습니다. 베시시는 개인정보처리방침을
            개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할
            것입니다. 본 방침은부터 2023년 10월 1일부터 시행됩니다.
          </p>
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            1. 개인정보의 처리 목적 베시시는 개인정보를 다음의 목적을 위해
            처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지
            않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다. 가.
            홈페이지 회원가입 및 관리 회원 가입의사 확인, 회원제 서비스 제공에
            따른 본인 식별·인증, 회원자격 유지·관리, 제한적 본인확인제 시행에
            따른 본인확인, 서비스 부정이용 방지, 고충처리 등을 목적으로
            개인정보를 처리합니다. 나. 민원사무 처리 민원인의 신원 확인,
            민원사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보 등을
            목적으로 개인정보를 처리합니다.
          </p>
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            2. 개인정보 파일 현황 베시시는 개인정보 보호법 제32조에 따라
            등록․공개하는 개인정보파일의 처리목적은 다음과 같습니다. 1. 개인정보
            파일명 : 베시시 홈페이지 회원 및 지원 관리 - 개인정보 항목 : 이메일,
          ...
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            3. 개인정보의 처리 및 보유 기간 ① 베시시는 법령에 따른 개인정보
            보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은
            개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다. ② 각각의
            개인정보 처리 및 보유 기간은 다음과 같습니다. 1. 홈페이지 회원가입
            및 관리 홈페이지 회원가입 및 관리와 관련한 개인정보는 수집.이용에
            관한 동의일로부터 3년까지 위 이용목적을 위하여 보유.이용됩니다. -
            보유근거 : 정보주체의 동의 - 관련법령 : 소비자의 불만 또는
            분쟁처리에 관한 기록 : 3년
          </p>
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            4. 정보주체와 법정대리인의 권리·의무 및 그 행사방법 이용자는
            개인정보주체로써 다음과 같은 권리를 행사할 수 있습니다. ① 정보주체는
            베시시에 대해 언제든지 개인정보 열람,정정,삭제,처리정지 요구 등의
            권리를 행사할 수 있습니다. ② 제1항에 따른 권리 행사는 베시시에 대해
            개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편,
            모사전송(FAX) 등을 통하여 하실 수 있으며 충북대학교 베시시는 이에
            대해 지체 없이 조치하겠습니다. ③ 제1항에 따른 권리 행사는 정보주체의
            법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다.
            이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을
            제출하셔야 합니다. ④ 개인정보 열람 및 처리정지 요구는 개인정보보호법
            제35조 제5항, 제37조 제2항에 의하여 정보주체의 권리가 제한 될 수
            있습니다. ⑤ 개인정보의 정정 및 삭제 요구는 다른 법령에서 그
            개인정보가 수집 대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수
            없습니다. ⑥ 베시시는 정보주체 권리에 따른 열람의 요구, 정정·삭제의
            요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
            대리인인지를 확인합니다.
          </p>
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            5. 처리하는 개인정보의 항목 작성 ① 베시시는 다음의 개인정보 항목을
            처리하고 있습니다. 1. 홈페이지 회원가입 및 관리 - 필수항목 : 이메일,
            휴대전화번호, 이름, 학번
          </p>
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            6. 개인정보의 파기 베시시는 원칙적으로 개인정보 처리목적이 달성된
            경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및
            방법은 다음과 같습니다. -파기절차 이용자가 입력한 정보는 목적 달성
            후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타
          ...
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            ...
            충북대학교 베시시는 개별적인 맞춤서비스를 제공하기 위해 이용정보를
          ...
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            8. 개인정보 보호책임자 ① 베시시는 개인정보 처리에 관한 업무를
            총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및
            피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고
            있습니다. ▸ 개인정보 보호책임자 성명: 성열암 직책: 충북대학교 학부생
            직급: 학생 연락처: developersung13@gmail.com ※ 개인정보 보호
            담당부서로 연결됩니다. ▸ 개인정보 보호 담당부서 부서명: 베시시
            담당자: 성열암 연락처: developersung13@gmail.com ② 정보주체께서는
            베시시의 서비스를 이용하시면서 발생한 모든 개인정보 보호 관련 문의,
            불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및
            담당부서로 문의하실 수 있습니다. 베시시는 정보주체의 문의에 대해
            지체 없이 답변 및 처리해드릴 것입니다.
          </p>
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            9. 개인정보 처리방침 변경 ① 이 개인정보처리방침은 시행일로부터
          ...
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            10. 개인정보의 안전성 확보 조치 베시시는 개인정보보호법 제29조에
            따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를
            하고 있습니다. 1. 정기적인 자체 감사 실시 개인정보 취급 관련 안정성
            확보를 위해 정기적(분기 1회)으로 자체 감사를 실시하고 있습니다. 2.
            개인정보 취급 직원의 최소화 및 교육 개인정보를 취급하는 직원을
            지정하고 담당자에 한정시켜 최소화 하여 개인정보를 관리하는 대책을
            시행하고 있습니다. 3. 내부관리계획의 수립 및 시행 개인정보의 안전한
            처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다. 4. 해킹
            등에 대비한 기술적 대책 베시시는 해킹이나 컴퓨터 바이러스 등에 의한
